...
def department_list(res: dict) -> list:
   dept_l: list = []
   for i in res:
...
def positions_year_examType(res: list) -> list:
   po_y_ex: list = []
   for i in range(len(res['bases'])):
      po_y_ex.append([res['bases'][i]['examType'], res['bases'][i]['positions'], res['bases'][i]['year']])
...
def get_positions_year_examType() -> list:
   link = 'https://vaseis.iee.ihu.gr/api/index.php/v1.0/bases/department/1625'
